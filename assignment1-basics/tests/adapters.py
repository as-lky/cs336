...
def run_multihead_self_attention(
    ...
    multihead_attention_now = LkyMultiheadAttention(d_model, num_heads, d_k, d_v, d_in, q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight)
    return multihead_attention_now(in_features)
    raise NotImplementedError
...
def run_multihead_self_attention_with_rope(
    ...
    multihead_attention_now = LkyMultiheadAttention(d_model, num_heads, d_k, d_v, d_in, q_proj_weight, k_proj_weight, v_proj_weight, o_proj_weight, theta=theta, max_seq_len=max_seq_len)
    return multihead_attention_now(in_features, token_positions)
    raise NotImplementedError
