...
def get_tokenizer_from_vocab_merges_path(
    ...
    #         print(token, ' ', gpt2_byte_decoder[token])
...
def test_single_unicode_character_matches_tiktoken():
    ...
    reference_ids = reference_tokenizer.encode(test_string)
    # print(reference_ids)
    # print(reference_tokenizer.encode('s'))
    # print(reference_tokenizer.encode("\u0120your"))
    # print(reference_tokenizer.encode('\u0120with'))
    # print(tokenizer.encode('s'))
    # print(tokenizer.encode("\u0120your"))
    # print(tokenizer.encode('\u0120with'))
